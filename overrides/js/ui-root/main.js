...
const FORCE_SINGLE_WORKSPACE_MODE = true;
...
function _enforceSingleWorkspaceCount() {
    ...
    if (!workspaceManager || workspaceManager.n_workspaces <= 1)
        return;
...
function _enableSingleWorkspaceMode() {
    if (!FORCE_SINGLE_WORKSPACE_MODE)
        return;
